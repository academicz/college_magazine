                    ...
                    <div id="mainnav-profile" class="mainnav-profile">
                        <div class="profile-wrap">
                            ...
                            <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                ...
                                <p class="mnp-name">{{ $admin->name }}</p>
                                <span class="mnp-desc">{{ $admin->email }}</span>
                            </a>
                        </div>
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(admin())
                            <li>
                                ...
                                <!--Submenu-->
                                <ul class="collapse">
                                    <li><a href="{{ route('departments') }}">Add Department</a></li>
                                    <li><a href="{{ route('courses') }}">Add Course</a></li>
                                    <li><a href="{{ route('moderators') }}">Add Moderator</a></li>
                                    <li><a href="{{ route('getFaculty') }}">Add Faculties</a></li>
                                    <li><a href="{{ route('getStudents') }}">Add Student</a></li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if(moderator())
                            <li>
                                ...
                                <!--Submenu-->
                                <ul class="collapse">
                                    <li><a href="{{ route('newArticles') }}">New Articles</a></li>
                                    <li><a href="{{ route('approvedArticles') }}">Approved Articles</a></li>
                                    <li><a href="{{ route('rejectedArticles') }}">Rejected Articles</a></li>
                                </ul>
                            </li>
                    @endif
