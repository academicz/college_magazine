        ...
        <div class="col-sm-12">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">Approved Articles</h3>
                </div>
                ...
                <div class="panel-body">
                    <div class="pages" v-if="total>0">
                        {{ (currentPage * pagination) - pagination + 1}} to {{ total > pagination ? (currentPage *
                        pagination) > total ? total : (currentPage * pagination) : total
                    ...
                    <ul class="pager pager-rounded" v-if="nextPageUrl !== null || previousPageUrl !== null">
                        ...
                        <li :class="nextPageUrl === null?'disabled':''"><a href=""
                                                                           @click.prevent="paginate(true,{fun:getArticles})">Next
                            <i
...
<script>
    ...
    export default {
        ...
        created(e) {
            this.getArticles('admin/moderator/getApprovedArticles');
        }
    }
</script>
<style scoped>
